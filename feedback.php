...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <img src="CAM00121.jpg" width=100 height=100 alt="Shailesh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Shailesh Kr</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8888888888</h4>
		<h4 style="font-family:'typo' ">shaileshkds1@gmail.com</h4>
		<h4 style="font-family:'typo' ">Vidya Vihar Institute of Technology, Purnia</h4></div></div>
		</p>
      </div>
